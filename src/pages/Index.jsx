      ...
      <div className="max-w-4xl mx-auto grid gap-8 md:grid-cols-2">
        ...
        <Card className="md:col-span-2">
          ...
          <CardContent className="flex flex-wrap justify-center gap-4">
            <img src="https://placekitten.com/300/200" alt="Cat 1" className="rounded-lg shadow-md" />
            <img src="https://placekitten.com/301/200" alt="Cat 2" className="rounded-lg shadow-md" />
            <img src="https://placekitten.com/302/200" alt="Cat 3" className="rounded-lg shadow-md" />
          </CardContent>
        </Card>
